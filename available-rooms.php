                                    	...
                                    	<div class="main-img h-grid-img">
                                            ...
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="price">₱2000<span class="divider">|</span><span class="pkg">Night</span></li>
                                                </ul>
                                            </div><!-- end main-mask -->
                                    	</div><!-- end h-grid-img -->
                                         ...
                                         <div class="block-info h-grid-info">
                                         	...
                                         	<h3 class="block-title"><a href="hotel-detail-left-sidebar.html">HRTSC ROOM ONE</a></h3>
                                            <p>2 Guests, 1 Matrimonial bed with complementary breakfast. </p>
                                            <div class="grid-btn">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-4">
                                    <div class="grid-block main-block h-grid-block">
                                        <div class="main-img h-grid-img">
                                            ...
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="price">₱1000<span class="divider">|</span><span class="pkg">Bed/Night</span></li>
                                                </ul>
                                            </div>
                                        </div>
                                         ...
                                         <div class="block-info h-grid-info">
                                            ...
                                            <h3 class="block-title"><a href="hotel-detail-left-sidebar.html">HRTSC ROOM TWO</a></h3>
                                            <p>2 Guests Twin or 2 Single Beds  with complementary breakfast. </p>
                                            <div class="grid-btn">
                                                 <a href="#thanks" data-toggle="modal">     
                                                <button class="btn btn-orange btn-block btn-lg">Book now</button>
                                                </a>
                                    ...
                                    <div class="grid-block main-block h-grid-block">
                                        <div class="main-img h-grid-img">
                                         ...
                                         <div class="block-info h-grid-info">
                                            ...
                                            <h3 class="block-title"><a href="hotel-detail-left-sidebar.html">HRTSC ROOM THREE</a></h3>
                                            <p>Triple sharing,3 single beds with complementary breakfast. </p>
                                            <div class="grid-btn">
                                                 <a href="#thanks" data-toggle="modal">     
                                                <button class="btn btn-orange btn-block btn-lg">Book now</button>
                                                </a>
                                    ...
                                    <div class="grid-block main-block h-grid-block">
                                        <div class="main-img h-grid-img">
                                         ...
                                         <div class="block-info h-grid-info">
                                            ...
                                            <h3 class="block-title"><a href="hotel-detail-left-sidebar.html">HRTSC ROOM FOUR</a></h3>
                                            <p>Quadruple sharing, 4 single beds with complementary breakfast.</p>
                                            <div class="grid-btn">
                                                 <a href="#thanks" data-toggle="modal">     
                                                <button class="btn btn-orange btn-block btn-lg">Book now</button>
                                                </a>
                             ...
                             <div class="col-sm-6 col-md-6 col-lg-4">
                                    <div class="grid-block main-block h-grid-block">
                                        <div class="main-img h-grid-img">
                                            ...
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="price">₱1200<span class="divider">|</span><span class="pkg">Night</span></li>
                                                </ul>
                                            </div>
                                        </div>
                                         ...
                                         <div class="block-info h-grid-info">
                                            ...
                                            <h3 class="block-title"><a href="hotel-detail-left-sidebar.html">TLSC ROOM ONE<a></h3>
                                            <p>2 Guests, 1 Matrimonial bed with complementary breakfast</p>
                                            <div class="grid-btn">
                                                 <a href="#thanks" data-toggle="modal">     
                                                <button class="btn btn-orange btn-block btn-lg">Book now</button>
                          ...
                          <div id="thanks" class="modal custom-modal fade" role="dialog">
                              ...
                              <div class="modal-body">
                                  <form>
                                        ...
                                        <div class="form-group">
                                            <p>Arrival Date</p>
                                            <input type="date" class="form-control dpd1" placeholder="Arrival Date" required/>
                                        </div>
                                        
                                        <div class="form-group">
                                            <p>Departure Date</p>
                                            <input type="date" class="form-control dpd2" placeholder="Departure Date" required/>
                                        </div>
